classdef (InferiorClasses = {?matlab.graphics.axis.Axes,...
    ...
    methods
        ...
        function obj = runBacktest(obj, pricesTT, varargin)
            ...
            [cashReturns, marginInterest] = computeCashReturns(obj,priceTimes);
            ...
            for i = 1:numel(strategies)
                ...
                for btIdx = 1:numTimeSteps
                    ...
                    cashReturni   = cashReturns(returnIdx);
                    marginInti    = marginInterest(returnIdx);
        ...
        function summaryTable = summary(obj)
            ...
            sharpeRatio     = sharpe(dailyReturns,obj.RiskFreeRate);
    ...
    methods (Access=protected)
        ...
        function [cashReturns, marginInterest] = computeCashReturns(obj,times)
